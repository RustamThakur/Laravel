...
<body>
	<div class="container mt-2">
		...
		<!-- <h2>Welcome {{$name ?? 'user'}} please add a task for today</h2> -->
		    ...
		    <div class="modal-content">
		      ...
		      <form method="post">
			      <div class="modal-body">
			       <input type="text" name="taskname" class="form-control taskadd" id="taskInput" placeholder="Add Task" required>
